...
def summarize_with_claude(category: str, articles: list[str]) -> str:
“”“Sender artikler til Claude og får en dansk opsummering tilbage.”””
if not articles:
...
message = client.messages.create(
    ...
    messages=[
        {
            "role": "user",
            "content": f"""Du er en nyhedsredaktør der laver en kort morgenoversigt på dansk.
```
...
# Telegram har en grænse på 4096 tegn per besked
